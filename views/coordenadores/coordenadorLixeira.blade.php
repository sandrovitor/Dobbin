        ...
        <div class="card">
            ...
            <div class="card-body" style="overflow-x:auto">
                <div class="alert alert-info small px-2 py-1">
                    <i class="fas fa-info-circle"></i> Coordenadores permanecerão na lixeira por 72h e depois serão excluídos automaticamente.
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <button class="dropdown-item" onclick="restauraCoordenador({{$c->id}})"><i class="fas fa-redo-alt fa-fw mr-1"></i> Restaurar</button>
                                        <div class="dropdown-divider"></div>
                                        <button class="dropdown-item text-danger" onclick="deleteCoordenadorLixeira({{$c->id}})"><i class="fas fa-trash fa-fw mr-1"></i> Apagar de vez</button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
