                            ...
                            <div class="row">
                                <div class="col-12 ">
                                    <div class="form-group">
                                        ...
                                        <textarea name="obs" rows="3" class="form-control form-control-sm form-control-solid" maxlength="450"></textarea>
                                    </div>
                                </div>
                            </div>
...
function salvarRoteiro()
{
    ...
    roteiro.obs = $('#roteironovo [name="obs"]').val();
    //console.log(roteiro);
    roteiroNovo(roteiro);
}
...
$(document).ready(function(){
    $(document).on('blur', '#roteironovo [name="data_ini"], #roteironovo [name="data_fim"]', function(){
        if($('#roteironovo [name="data_ini"]').val() != '' && $('#roteironovo [name="data_fim"]').val() != '') {
            ...
            $('#roteironovo [name="valor_dias"]').attr('max', Dobbin.diffDays( new Date($('#roteironovo [name="data_ini"]').val()), new Date($('#roteironovo [name="data_fim"]').val()) ) + 1);
        } else {
